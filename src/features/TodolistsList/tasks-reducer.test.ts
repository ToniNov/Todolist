...
const {removeTask,addTask,updateTask,fetchTasks } = tasksAsyncActions
...
test('correct task should be added to correct array', () => {
    //const action = addTask.fulfilled("juce", "todolistId2");
    ...
    const action = addTask.fulfilled(task, "reqestId", {title: task.title, todolistId: task.todoListId});
